...
Static legal pages for Dr.Speak.
...
These files are plain HTML and CSS. They can be hosted on GitHub Pages from a
public repository or any static hosting provider.

The current target hosting URL is GitHub Pages under:

https://soo-kate-yeon.github.io/drspeak-legal/
